...
const FAQS = [
  ...
  { q: "¿Cómo me postulo como conductor?", a: "Desde tu perfil, tocá \"Quiero conducir con BearDrive\" y completá la documentación requerida." },
  { q: "¿Qué son los BearPoints?", a: "Son puntos que acumulás al completar viajes. Podés canjearlos por beneficios en la pestaña Beneficios." },
];
    ...
    <div className="h-[100dvh] overflow-y-auto bg-background">
      <div className="max-w-md mx-auto px-5 pt-8 pb-10">
        ...
        <Card className="p-5 space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {CATEGORIES.map((c) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${category === c.code ? "bear-gradient text-white" : "bg-secondary text-muted-foreground"}`}
                >
                  {c.label}
                </button>
              ))}
          ...
          <Button onClick={handleSubmit} disabled={sending} className="w-full bear-gold-gradient text-foreground border-0">
