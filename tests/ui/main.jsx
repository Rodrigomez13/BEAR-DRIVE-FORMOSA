...
createRoot(document.getElementById('root')).render(<BrowserRouter><div className="p-4"><p>Prueba local con datos simulados</p><nav className="flex gap-4"><Link to="/operations">Soporte</Link><Link to="/change">Cambio de destino</Link><Link to="/passenger/benefits">Deuda</Link></nav></div><Routes><Route path="/operations" element={<div className="p-4"><AdminOperations/></div>}/><Route path="/change" element={<Change/>}/><Route path="*" element={<AccountDebtNotice><div>Beneficios</div></AccountDebtNotice>}/></Routes></BrowserRouter>);
